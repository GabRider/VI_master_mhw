<template>
    <div class="form-row px-1 my-1 w-100">
        ...
        <div class="input-group form-group col-7">
            ...
            <!-- Update set -->
            <div class="input-group-append">
                <button class="btn btn-outline-primary" type="button" @click="updateSet">
                    Update
                </button>
            </div>
            <!-- Delete set -->
            <div class="input-group-append">
                <button class="btn btn-outline-danger" type="button" @click="deleteSet">
                    Delete
                </button>
            </div>
            <!-- Delete set -->
            <div class="input-group-append">
                <button class="btn btn-outline-primary" type="button" @click="exportSet">
                    Export
                </button>
            </div>
        </div>
